...
CRITERIA = [
    {
        ...
        "checks": [
            ("act-close-is-unattended",
             ...
             lambda: file_contains("archon/close.py",
            ...
            ("act-writes-artifacts",
             ...
             lambda: file_contains("archon/drafts.py", r"class DraftKind|DRAFT_FOR_FINDING")),
            ("act-unattended-trigger",
             "An object landing in the bucket closes the month with nobody present",
             lambda: file_contains("archon/service.py", r'@app.post\("/events"\)')),
    ...
    },
    {
        ...
        "checks": [
            ("spn-framework-in-code",
             ...
             lambda: file_contains("archon/agents.py", r"from google\.adk")),
            ("spn-infra-in-code",
             "A Google Cloud infrastructure service is wired into shipped code",
             lambda: file_contains("archon/store.py", r"from google\.cloud import firestore")),
            ("spn-named-in-readme",
